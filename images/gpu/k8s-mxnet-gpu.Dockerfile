...
ENV LD_LIBRARY_PATH /mxnet/mkl/lib:$LD_LIBRARY_PATH
 ...
 #&& make clean 
RUN apt-get -f install apt-utles && apt-get -f install make 
RUN cd /mxnet &&  \ 
...
#COPY t10k-images-idx3-ubyte.gz /mxnet/example/image-classification/data
#COPY t10k-labels-idx1-ubyte.gz /mxnet/example/image-classification/data
#COPY train-images-idx3-ubyte.gz /mxnet/example/image-classification/data
#COPY train-labels-idx1-ubyte.gz /mxnet/example/image-classification/data
