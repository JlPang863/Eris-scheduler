...
def download_cifar10():
    ...
    download_file('http://data.mxnet.io/data/cifar10/cifar10_val.rec', fnames[1])  #.rec denote the format of RecordIO  
...
if __name__ == '__main__':
    ...
    #load data before
    data_dir = "/data/"
    train_fname = data_dir + 'cifar10_train.rec'
    ...
    # train
    fit.fit(args, sym, data.get_rec_iter) #data.get_rec_iter() returns the training data and val data
