    ...
    def _generate(self):
        ...
        for i in xrange(params.TOT_NUM_JOBS):
            if params.JOB_DISTRIBUTION == "uniform":
                ...
                index = random.randint(0,len(jobrepo.job_repos)-1) # index = workload_id, represents the type of  jobs
            ...
            if params.JOB_ARRIVAL == "uniform":
                t = random.randint(1, math.ceil(0.8 * params.T))  # clock start from 1
                job.arrival_slot = t
